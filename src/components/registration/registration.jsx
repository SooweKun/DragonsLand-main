...
export const Registration = ({check1}) => {
    ...
    return(
        ...
        >
            ...
            <p className="text-2xl text-slate-600 mb-[50px]">Sing Up</p>
            ...
            <button className="bg-grays w-[95px] h-[40px] rounded-lg" onClick={handleSubmit(check1)}>sing up</button>
        </form>
    );
}